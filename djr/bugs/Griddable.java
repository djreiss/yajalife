...
public class Griddable implements Serializable {
   ...
   public final boolean addToGrid() {
      return grid != null ? grid.addToGrid( this ) : false;
   }

   public final boolean removeFromGrid() {
   ...
   public static final String formatString( String s, final int numSpaces ) {
   ...
   protected final void move( int tox, int toy ) {
