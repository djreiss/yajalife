...
public class Resource extends Genome implements Serializable {
   ...
   public final double getRewardForIO( final int[] in, final int[] out, 
				       final int[] alreadyRewarded ) {
	 ...
	 return 1.0;
      ...
      final double outReward = reward[ alreadyRewarded[ resIndex ] ];
   ...
   private final void printTestOutput( int[] in, int[] out ) {
   ...
   public static double testGlobalOutputs( final Globals globals, final int[] in, 
					   final int[] out, final int[] alreadyRewarded ) {
   ...
   public static double testLocalOutputs( final Globals globals, final int[] in, 
					  final int[] out, final int[] alreadyRewarded, 
					  int x, int y ) {
      int save = globals.point_mut;
      globals.point_mut = 0;
   ...
   public static boolean addNewGlobalResources( final Globals globals ) {
   ...
   public static boolean addNewLocalResources( final Globals globals ) {
   ...
   private static void countResourcesAtLocation( final Globals globals, int resIndex, 
   ...
   public static String printStats( final Globals globals ) {
